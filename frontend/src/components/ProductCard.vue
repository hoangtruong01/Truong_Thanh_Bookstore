<template>
  ...
  >
    ...
    <!-- Add to Cart -->
    <button @click="$emit('add-to-cart', product)" class="mt-3 w-full bg-[#ffebd5] hover:bg-[#dc2626] text-[#c2410c] hover:text-white font-extrabold py-2 px-3 rounded-xl text-xs transition-all flex items-center justify-center gap-1 border border-[#fed7aa] cursor-pointer">
