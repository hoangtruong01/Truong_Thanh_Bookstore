...
- **TASK 13 [P1] — Product Detail [DONE]**: API chi tiết sản phẩm toàn diện (tự động phân biệt MongoDB ObjectId / SEO Slug, populate danh mục, thuộc tính sách & văn phòng phẩm), thuật toán gợi ý sản phẩm liên quan (`GET /products/:id/related`), thư viện ảnh Gallery & Modal Lightbox toàn màn hình, bảng thông số kỹ thuật đa năng, hệ thống phân bổ đánh giá 5 mức sao (1★ - 5★) kèm bộ lọc và huy hiệu *✓ Đã mua hàng*, đồng bộ 100% trên Backend, Frontend Vue 3 và Mobile Flutter. 180 unit tests PASS 100%.
